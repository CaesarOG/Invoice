...
import { SignInReducer, SignUpReducer, RegisterReducer, EditInvoiceReducer,
  InvoicesHomeReducer, WidgetReducer, HeaderReducer, SideBarReducer, SliderReducer,
  CompanyDetReducer, AppReducer } from '../reducers'
...
export default combineReducers({
    ...
    WidgetReducer, HeaderReducer, SideBarReducer, SliderReducer, CompanyDetReducer, AppReducer
});